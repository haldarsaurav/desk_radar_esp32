...
- 🔁 automatic range cycling through **20 km**, **40 km**, and **60 km** outer-range views
...
The range cycling is important: the main radar does not stay at one fixed zoom. It keeps moving through **20 km**, **40 km**, and **60 km** views. The **20 km** view is for close local traffic, the **40 km** view is the useful middle ground, and the **60 km** view gives the bigger Freising-to-Munich picture.
...
- 🌬️ wind and temperature from Munich weather
- 🔢 DEP / GND / ARR counters
- 🏷️ next arrival and next departure labels when available

I like this page because it makes Munich feel like a tiny live airport board, but on a round watch-sized screen.

The MUC map is more zoomed-in than the home radar. The main airport drawing is a **20 km** view around Munich Airport. Aircraft between **20 km and 40 km** from the airport become blue rim dots, so I can still see that something is nearby without crowding the runway map.
...
- **ACTIVITY**: a wider **100 km** feel for how busy the sky is around the area
...
- 🆔 callsign
- 🛩️ aircraft type
- 🏷️ airline or operator when known
- 🗺️ route when available
- ⬆️ altitude
- 💨 speed
- 📏 distance from me
- 📈 climb or descent trend
- ⏱️ closest point of approach
...
- 📦 **An-124**: rare heavy cargo aircraft
...
- 🕰️ **MD-11 / A340-500 / A340-600**: rare types that are not everyday traffic anymore
...
- 📍 low overhead pass, especially something within about **4 km** and below about **3,500 ft**
...
- 🛩️ estimate where aircraft move between updates so the display feels smooth
- 🛬 decide whether aircraft look like arrivals, departures, ground traffic, helicopters, or special traffic
- 🗺️ add route/operator information when available
- 🌦️ decode Munich Airport weather into readable rows
